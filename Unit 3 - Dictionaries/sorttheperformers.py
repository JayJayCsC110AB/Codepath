...
def sort_performers(performer_names, performance_times):
    ...
    for i in range(len(performer_names)):
       performance[performer_names[i]] = performance_times[i]
       if performance[performer_names[i]] > performance[performer_names[count]]:
        count = i
    return str.append(performance_times[count])
